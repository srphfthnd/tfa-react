...
function Accordion() {
  ...
  const FAQCONTENTSJSON = [
    {
      question: "Who can borrow money from The Funding Alliance?",
      answer:
    ...
    {
      question: "How much can I borrow from The Funding Alliance?",
      answer:
    ...
    {
      question:
        "How does The Funding Alliance evaluate your credit worthiness?",
      answer:
    ...
    {
      question: "How do I repay The Funding Alliance?",
      answer:
    ...
    {
      question:
        "Are there any fees or additional costs associated with applying for financing with The Funding Alliance?",
      answer:
    ...
    {
      question:
        "Does The Funding Alliance lend to those with previous bankruptcies and tax liens?",
      answer:
    ...
    {
      question:
        "Does The Funding Alliance require a change of credit card processors?",
      answer:
    ...
    {
      question: "Does The Funding Alliance require a personal guarantee?",
      answer:
